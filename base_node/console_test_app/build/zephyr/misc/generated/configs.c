...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CUSTOM_SENSOR_NODE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_BOS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_OS_DESC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_TEST_APP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_TEST_APP_INIT_PRIORITY, 90);
